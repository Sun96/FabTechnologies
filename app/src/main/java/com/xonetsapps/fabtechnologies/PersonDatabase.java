...
public class PersonDatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + Table_NAME + "(ID INTEGER PRIMARY KEY AUTOINCREMENT, NAME TEXT, SURNAME TEXT, QTY TEXT,PRICE TEXT)");
    }
    ...
    public boolean insertdata(String name, String surname,String qty,String price){
    ...
    public Boolean updateuserData(String id,String name, String surname,String qty){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
